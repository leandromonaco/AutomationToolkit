...
using AutomationToolkit.VersionOne;
...
namespace AutomationToolkit.Test
{
    public class VersionOneTest
    {
        ...
        VersionOneRepository _v1Repository;
        ...
        public VersionOneTest()
        {
            ...
            _v1Repository = new VersionOneRepository(_configuration["VersionOne:Url"], _configuration["VersionOne:Key"], AuthenticationType.Bearer);
        }
